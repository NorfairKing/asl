      ...
      where
        percenter o_ key = do
            ...
            case v of
                Array a ->
                    case V.toList a of
                        (acc:read_:write1:write2:write3:_) ->
                            PerCenter <$> parseJSON acc <*> parseJSON read_ <*> parseJSON write1 <*>
                            parseJSON write2 <*>
                            parseJSON write3
                        _ ->
                            fail $
                            "Unable to parse ByOctaveMyModelSolution percenter array " <>
                            T.unpack key

...
smallLocalReplicationEffect =
    smallRemoteReplicationEffect
    { hlConfig =
          (hlConfig smallRemoteReplicationEffect)
          {target = smallLocalReplicationEffectRule, location = Local}
    }
...
localReplicationEffect =
    remoteReplicationEffect
    { hlConfig =
          (hlConfig remoteReplicationEffect)
          {target = localReplicationEffectRule, location = Local, resultsPersistence = Volatile}
    }

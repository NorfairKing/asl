...
allFactorialExperiments =
    [smallLocalFactorial, localFactorial, smallRemoteFactorial, remoteFactorial]

smallLocalFactorial :: FactorialCfg
smallLocalFactorial =
    smallRemoteFactorial
    { hlConfig =
          (hlConfig smallRemoteFactorial) {target = "small-local-2k-factorial", location = Local}
    }
...
localFactorial =
    remoteFactorial
    { hlConfig =
          (hlConfig remoteFactorial)
          {target = "local-2k-factorial", resultsPersistence = Volatile, location = Local}
    }
...
smallRemoteFactorial =
    ...
    { hlConfig =
          (hlConfig remoteFactorial)
          {target = "small-remote-2k-factorial", resultsPersistence = Volatile, repititions = 1}
    , fRuntime = Seconds 5
    }

...
data FactorialCfg = FactorialCfg
        ...
        let setups = do
                ...
                let signGlobally f =
                        intercalate
                            "-"
                            [ f
                            , show curWritePercentage
                            , show curValueSize
                            , show curReplicationCoefficient
                            ]
                ...
                let defaultClients =
                        genClientSetup fc cls (middleRemoteServer . middle) signGlobally fRuntime
                let clients =
                                ...
                                in cs
                                   { cMemaslapSettings =
                                         ...
                                         { msConfig =
                                               config
                                               { valueDistributions =
                                                     [Distribution curValueSize curValueSize 1]

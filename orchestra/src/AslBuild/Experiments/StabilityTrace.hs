...
stabilityTraceRules = mapM_ generateTargetFor allStabilityTraceExperiments

allStabilityTraceExperiments :: [StabilityTraceCfg]
allStabilityTraceExperiments =
    [smallLocalStabilityTrace, localStabilityTrace, smallRemoteStabilityTrace, remoteStabilityTrace]
...
smallLocalStabilityTrace =
    ...
    { hlConfig =
          (hlConfig smallRemoteStabilityTrace)
          {target = smallLocalStabilityTraceRule, location = Local}
    }
...
localStabilityTrace =
    ...
    { hlConfig =
          (hlConfig remoteStabilityTrace)
          {target = localStabilityTracelRule, location = Local, resultsPersistence = Volatile}
    }

...
baselineExperimentRules
    = mapM_ generateTargetFor allBaselineExperiments
...
smallLocalBaselineExperiment = smallRemoteBaselineExperiment
    { hlConfig = (hlConfig smallRemoteBaselineExperiment)
...
localBaselineExperiment = remoteBaselineExperiment

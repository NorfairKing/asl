...
allWriteEffectExperiments =
    [smallLocalWriteEffect, localWriteEffect, smallRemoteWriteEffect, remoteWriteEffect]
...
smallLocalWriteEffect =
    ...
    { hlConfig =
          (hlConfig smallRemoteWriteEffect) {target = smallLocalWriteEffectRule, location = Local}
    }
...
localWriteEffect =
    remoteWriteEffect
    { hlConfig =
          (hlConfig remoteWriteEffect)
          {target = localWriteEffectRule, location = Local, resultsPersistence = Volatile}
    }

...
data ReplicationEffectCfg = ReplicationEffectCfg
    ...
    genExperimentSetups stc@ReplicationEffectCfg {..} = do
        ...
        let setups = do
                ...
                let replicationFactor =
                        max 1 $ ceiling $ fromIntegral curNrServers * replicationFactorFactor
                ...
                let defaultClients =
                        genClientSetup stc cls (middleRemoteServer . middle) signGlobally reRuntime
                let clients =

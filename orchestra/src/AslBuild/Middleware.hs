...
runLocalMiddleware :: CmdResult r => MiddlewareFlags -> Action r
runLocalMiddleware flags = cmd $ localMiddlewareCmd flags
...
middlewareCmds midPath flags =
    [ javaCmd
    , "-jar"
    , midPath
    ] ++ middlewareArgs flags

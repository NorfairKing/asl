        ...
        fss <-
            forM slocss $ \slocs -> do
                ...
                inds <-
                    forM erMiddleResultsFiles $ \erMiddleResultsFile -> do
                        ...
                        attf %> \_ -> do
                            ...
                            putLoud $
                                unwords
                                    ["Gathering average think time data from", ttf, "into", attf]
                ...
                mavgf %> \_ -> do
                    ...
                    putLoud $
                        unwords
                            ["Gathering meta average think time data from", show afs, "into", mavgf]
...
calcAvgThinkTime path = do
    let withFold fold =
            ...
            withFile path ReadMode $ \inHandle -> do
                let prod =
                        P.decodeByName (PB.fromHandle inHandle) >-> errorIgnorer >->

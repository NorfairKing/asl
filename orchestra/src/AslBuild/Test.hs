...
javadeps =
    map
        (\(name, url) -> (javalibdir </> name <.> jar, url))
        [ ("junit", "http://central.maven.org/maven2/junit/junit/4.12/junit-4.12.jar")
        , ( "junit-quickcheck-core"
          , "http://central.maven.org/maven2/com/pholser/junit-quickcheck-core/0.6.1/junit-quickcheck-core-0.6.1.jar")
        , ( "junit-quickcheck-generators"
          , "http://central.maven.org/maven2/com/pholser/junit-quickcheck-generators/0.6.1/junit-quickcheck-generators-0.6.1.jar")
        , ( "hamcrest-core"

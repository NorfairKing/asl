...
\includegraphics[width=\textwidth]{../analysis/baseline-localhost-tps-1.png}
\includegraphics[width=\textwidth]{../analysis/baseline-localhost-tps-2.png}

\subsection{Response time}\label{sec:baseline:rt}

\includegraphics[width=\textwidth]{../analysis/baseline-localhost-avg-1.png}
\includegraphics[width=\textwidth]{../analysis/baseline-localhost-avg-2.png}

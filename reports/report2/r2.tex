...
\begin{figure}
  \centering
    \includegraphics[width=0.45\textwidth]{\plot{summary-locations-absolute-1-slice.png}}
    \includegraphics[width=0.45\textwidth]{\plot{summary-locations-relative-1-slice.png}}
  \caption{Maximum Throughput Trace Slice (1 middleware thread)}
\end{figure}
\begin{figure}
  \centering
    \includegraphics[width=0.45\textwidth]{\plot{summary-locations-absolute-6-slice.png}}
    \includegraphics[width=0.45\textwidth]{\plot{summary-locations-relative-6-slice.png}}

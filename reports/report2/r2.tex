...
Sadly, due tue Java's strict evaluation semantics, the logging messages were still constructed even if they weren't printed.
...
One fracton of the requests will be read requests and the rest will be write requests.

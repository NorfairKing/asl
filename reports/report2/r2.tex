...
\begin{figure}
  \centering
    \includegraphics[width=0.48\textwidth]{\plot{local-maximum-throughput-maximum-throughput.png}}
    \includegraphics[width=0.48\textwidth]{\plot{big-local-maximum-throughput-maximum-throughput.png}}
...
\begin{figure}
  \centering
    \includegraphics[width=\textwidth]{\plot{local-maximum-throughput-slice-absolute-1-slice.png}}
...
\begin{figure}
  \centering
    \includegraphics[width=\textwidth]{\plot{local-maximum-throughput-slice-relative-1-slice.png}}
...
\begin{figure}
  \centering
    \includegraphics[width=\textwidth]{\plot{big-local-maximum-throughput-slice-absolute-1-slice.png}}
  \caption{Maximum Throughput Absolute Trace Slice (1 middleware thread)}
  \label{fig:maximum-throughput-trace-slice-1-thread-absolute}
\end{figure}
...
\begin{figure}
  \centering
    \includegraphics[width=\textwidth]{\plot{big-local-maximum-throughput-slice-relative-1-slice.png}}
  \caption{Maximum Throughput Relative Trace Slice (1 middleware thread)}
  \label{fig:maximum-throughput-trace-slice-1-thread-relative}
\end{figure}

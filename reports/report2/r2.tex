...
\begin{figure}
  \centering
    ...
    \end{subfigure}
    \begin{subfigure}{0.48\textwidth}
    \includegraphics[width=\textwidth]{\plot{remote-maximum-throughput-maximum-throughput-25-tps.png}}
    \includegraphics[width=\textwidth]{\plot{remote-maximum-throughput-maximum-throughput-25-resp.png}}
    \includegraphics[width=\textwidth]{\plot{remote-maximum-throughput-slice-absolute-25-slice.png}}
    \includegraphics[width=\textwidth]{\plot{remote-maximum-throughput-slice-relative-25-slice.png}}
    \end{subfigure}
  \caption{Maximum Throughput}
\end{figure}

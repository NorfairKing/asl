...
This is to be expected for the same reason as the higher throughput for two clients: thread contention.

Second, the average response time stays constant up to 12 virtual clients, and the standard deviation remains small as well.

...
\includegraphics[width=0.5\textwidth]{\plot{local-stability-trace-read-resp.png}}
\includegraphics[width=0.5\textwidth]{\plot{local-stability-trace-write-resp.png}}

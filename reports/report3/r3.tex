...
\begin{figure}[H]
  \centering
  \input{\genfile{remote-2k-factorial-sign-table-tps.tex}}
  \caption{Throughput Sign Table}
  \label{fig:tps-sign-table}
\end{figure}
...
\begin{figure}[H]
  \centering
  \input{\genfile{remote-2k-factorial-sign-table-resp.tex}}
  \caption{Response Time Sign Table}
  \label{fig:resp-sign-table}
\end{figure}

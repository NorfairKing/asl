...
For this model, we use the same black box as in the last section.
...
\begin{itemize}
  ...
  \item
    The decrease in real response times is dependent on the replication coefficient.
    The response time decreases more slowly the higher the replication coefficient.
\end{itemize}
...
\TODO{DO SOMETHING SIMILAR FOR THE WRITE EFFECT EXPERIMENT}

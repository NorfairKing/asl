...
public class ResponseParser {
    ...
    public static List<Response> parseResponses(ByteBuffer byteBuffer) throws NotEnoughDataException, ParseFailedException {
    ...
    private static ParseResult parseSingleInternal(ByteBuffer byteBuffer, int offset) throws NotEnoughDataException, ParseFailedException {
        int position = byteBuffer.position();

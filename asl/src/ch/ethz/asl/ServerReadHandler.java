...
public class ServerReadHandler {
    ...
    public ServerReadHandler(
        ...
        this.threadPool = Executors.newFixedThreadPool(readThreadpoolSize); // Leave room to submit itself.
    ...
    class ReadWorker implements Runnable {
        ...
        private void handleOneRequest() throws InterruptedException {
            ...
            log.fine(readWorkerIndex + " dequeuing from readqueue for server " + serverAddress + " now sized " + readqueue.size());
            packet = readqueue.take();
            log.fine(readWorkerIndex + " dequeud from readqueue for server " + serverAddress + " now sized " + readqueue.size());
            packet.setDequeued();
            ...
            log.fine("Readworker " + readWorkerIndex + " for server " + serverAddress + " done with request.");
        }
